...
// 1. Aksi ketika tombol "Buka Undangan" diklik
btnBuka.addEventListener("click", () => {
  // Hilangkan tampilan awal secara halus
  tampilanAwal.style.transition = "opacity 0.5s ease";
  tampilanAwal.style.opacity = "0";
  tampilanAwal.style.pointerEvents = "none";

  setTimeout(() => {
    tampilanAwal.style.display = "none";
  }, 500);

  // Hanya putar video dan musik (Jangan munculkan kubah di sini)
  video.play();
  music.play();
});

// 2. TEPAT DI SINI KUNCI NYA: Kubah baru muncul saat video SELESAI
...
// TAMBAHKAN KODE INI DI BARIS PALING BAWAH FILE SCRIPT.JS KAMU:
